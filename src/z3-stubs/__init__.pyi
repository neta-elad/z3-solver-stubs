...
class ModelRef(Z3PPObject):
    ...
    @overload
    def __getitem__(self, t: FuncDeclRef) -> FuncInterp: ...
...
class Solver:
    ...
    def assert_and_track(self, arg: BoolRef, name: str | Bool) -> None: ...
...
def PrefixOf(prefix: SeqRef | str, string: SeqRef | str) -> BoolRef: ...
def SuffixOf(suffix: SeqRef | str, string: SeqRef | str) -> BoolRef: ...
def Contains(haystack: SeqRef | str, needle: SeqRef | str) -> BoolRef: ...
@overload
def Concat(a: ReRef, b: ReRef) -> ReRef: ...
@overload
def Concat(a: SeqRef | str, b: SeqRef | str) -> SeqRef: ...
